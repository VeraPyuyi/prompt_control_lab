...
Research-first prompt-control toolkit with eval evidence, model provenance, and agent-audit artifacts. Package: `promptcontrollab`. Chinese: [README.zh.md](README.zh.md).
...
- **Applied Agent Layer:** `pcl guard`, `audit-diff`, model provenance, `pcl ui`, plugins, and GitHub templates.
