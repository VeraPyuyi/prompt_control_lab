...
from promptcontrollab.integrations.hf_demo import is_hf_demo, require_hf_demo_workflow
...
def run_analyze_workflow(
    *,
    ...
    outputs = [
        ...
        out_dir / "evidence_card.html",
        out_dir / "claim_check.json",
        out_dir / "claim_check.md",
        out_dir / "claim_check.html",
        out_dir / "report.md",
        out_dir / "report.html",
    ]
...
def run_evidence_card_workflow(
    *,
    ...
    return _handle_execution(
        name="evidence-card",
        command=command,
        outputs=[resolved_json, resolved_markdown, resolved_markdown.with_suffix(".html")],
        execution_mode=execution_mode,
        confirmed=confirmed,
        overwrite=overwrite,
        safe_root=safe_root,
...
def run_external_evidence_workflow(
    *,
    ...
    outputs = [
        ...
        out_dir / "claim_check.md",
        out_dir / "claim_check.html",
        out_dir / "research_bundle.html",
        out_dir / "research_bundle.json",
        out_dir / "research_diagnostics.json",
        out_dir / "research_diagnostics.md",
        out_dir / "research_diagnostics.html",
        out_dir / "research_gap_plan.json",
        out_dir / "research_gap_plan.md",
        out_dir / "research_gap_plan.html",
        out_dir / "report.html",
