...
class EcosystemDemoSpec:
    """Describe one bundled external evaluation export used by the demo."""
...
class PromptOptimizerAssetSpec:
    """Describe one bundled prompt-asset export used by the demo."""
...
def _scorecard_rows(*, out_dir: Path, payload: JsonDict, diagnostics: JsonDict) -> list[JsonDict]:
    """Build normalized cross-tool evidence rows for the ecosystem scorecard."""
