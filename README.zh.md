...
> 当前为公开 Alpha 源码预览：`promptcontrollab 0.2.0a1`。仓库包含两项有边界的真实验收案例；GitHub Release 构建产物和 PyPI 包尚未发布。
...
## 在 Hugging Face 体验
[![在 Hugging Face 体验](https://img.shields.io/badge/🤗%20在线体验-Hugging%20Face-yellow)](https://huggingface.co/spaces/VeraPyuyi/prompt-control-lab)
<p><a href="https://huggingface.co/spaces/VeraPyuyi/prompt-control-lab"><img src="docs/assets/hf_space.zh.png" alt="PromptControlLab Hugging Face 中文公共演示"></a></p>
...
| 诊断证据 | 终端敏感度、Green 边界与后验检查；trajectory/turnpike、Riccati/DARE、soft-hard/time-varying control、generation mismatch、selective risk、checkpoint gate |
