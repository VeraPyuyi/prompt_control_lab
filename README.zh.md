...
研究优先的 prompt-control 工具：评测证据、模型溯源和 agent 审计都在本地完成。包名：`promptcontrollab`。英文版：[README.md](README.md)。
...
- **Applied Agent Layer：** `pcl guard`、`audit-diff`、模型溯源、`pcl ui`、插件、GitHub 模板。
