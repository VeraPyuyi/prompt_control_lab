...
`prompt_control_lab` 把 prompt 优化实验变成可审计证据：干净切分、成对统计、soft-to-hard gap、hidden-state trajectory、Riccati 探针和 time-varying soft-control 对比。Python 包名：`promptcontrollab`。英文文档：[README.md](README.md)。
